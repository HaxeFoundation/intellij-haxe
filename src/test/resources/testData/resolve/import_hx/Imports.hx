...
<info descr="null">trace</info>(<info descr="Convert to String interpolation">"length = " + <info descr="null">t</info>.<info descr="null">helper</info>.<info descr="null">length</info>()</info>);
    while (0 < <info descr="null">t</info>.<info descr="null">helper</info>.<info descr="null">length</info>())
      <info descr="null">trace</info>(<info descr="null">t</info>.<info descr="null">helper</info>.<info descr="null">pop</info>());
  ...
  public function <info descr="null">answer</info>() {  // Demonstrates two levels of import.hx work from Helper.hx.
    <info descr="null">trace</info>("answer called.");
