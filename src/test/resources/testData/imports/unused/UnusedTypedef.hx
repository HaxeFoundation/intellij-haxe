...
<warning descr="Unused import statement">import <text_attr descr="null"><text_attr descr="null">helper.Typedefs</text_attr>.RegularTypedef</text_attr>;</warning>

class <text_attr descr="null">UnusedTypedef</text_attr> {
