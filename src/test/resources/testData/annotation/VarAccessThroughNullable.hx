...
class <info descr="null">Test</info> {
  ...
  public function <info descr="null">new</info>() {
    ...
    <info descr="null">trace</info>(<info descr="null">t2</info>.<info descr="null">s</info>);
    <info descr="null">trace</info>(<info descr="null">t2</info>.<warning descr="Unresolved symbol">unknown</warning>);
  }
}
