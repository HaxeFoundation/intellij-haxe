...
public class HaxeCompilerErrorParsingTest {
  ...
  public void disabledtestUserProperiesErrorWin() {
    ...
    assertEquals(Category.ERROR, compilerError.getCategory());
    assertEquals("C:/Users/fedor.korotkov/workspace/haxe-bubble-breaker/src/Main.hx", compilerError.getPath());
    assertEquals("Class not found : StringTools212", compilerError.getMessage());
  ...
  public void testNMEErrorRelativeUnix() {
    ...
    assertEquals("Unknown identifier : addEvetListener", compilerError.getMessage());
  ...
  public void testNMEErrorNoColumnUnix() {
    ...
    assertEquals("Interfaces cannot implement another interface (use extends instead)", compilerError.getMessage());
  ...
  public void testWarnings() {
    ...
    assertNotNull(compilerError);
    assertEquals(Category.WARNING, compilerError.getCategory());
    assertEquals("/trees/test/hello/HelloWorld.hx", compilerError.getPath());
    assertEquals("Danger, Will Robinson!", compilerError.getMessage());
    assertEquals(18, compilerError.getLine());
    assertEquals(-1, compilerError.getColumn());
  }
