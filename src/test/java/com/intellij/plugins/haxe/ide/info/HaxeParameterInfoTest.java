...
public class HaxeParameterInfoTest extends LightPlatformCodeInsightTestCase {
  ...
  private void configureLoggerForDebugging() {
    Logger.getInstance(HaxeResolveUtil.class).setLevel(LogLevel.DEBUG);
    Logger.getInstance(HaxeReferenceImpl.class).setLevel(LogLevel.DEBUG);
    Logger.getInstance(HaxeClassResolveResult.class).setLevel(LogLevel.TRACE);
  }
