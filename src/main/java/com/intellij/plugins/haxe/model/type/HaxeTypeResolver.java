...
public class HaxeTypeResolver {
  ...
  static public ResultHolder getTypeFromFunctionType(HaxeFunctionType type) {
    ArrayList<SpecificFunctionReference.Argument> args = new ArrayList<>();
    ...
    for (int i = 0; i < list.size(); i++) {
      ...
      args.add(new SpecificFunctionReference.Argument(i, argument.getOptionalMark() != null, argumentType, getArgumentName(argument)));
    }
