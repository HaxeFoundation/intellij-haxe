...
public class HaxeExternClassModel extends HaxeClassModel {
  public HaxeExternClassModel(@NotNull HaxeExternClassDeclaration haxeClass) {
    super(haxeClass);
  }
  ...
  public HaxeExternClassDeclaration getExternClass() {
    return (HaxeExternClassDeclaration)getBasePsi();
  }

  private HaxeExternClassDeclarationBody getExternBody() {
