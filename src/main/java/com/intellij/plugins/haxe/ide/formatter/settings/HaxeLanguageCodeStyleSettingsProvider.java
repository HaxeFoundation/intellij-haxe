...
public class HaxeLanguageCodeStyleSettingsProvider extends LanguageCodeStyleSettingsProvider {
  ...
  public void customizeSettings(@NotNull CodeStyleSettingsCustomizable consumer, @NotNull SettingsType settingsType) {
    if (settingsType == SettingsType.SPACING_SETTINGS) {
      ...
      String spacesOther = CodeStyleSettingsCustomizableOptions.getInstance().SPACES_OTHER;

      consumer.showCustomOption(HaxeCodeStyleSettings.class, "SPACE_AROUND_ARROW", "Around ->",
                                spacesOther, CodeStyleSettingsCustomizable.OptionAnchor.NONE);
  ...
  public static final String WRAPPING_CODE_SAMPLE = "@author(\"Penelope\") @:final\n" +
                                                    "class Foo {\n" +
                                                    "    // function fBar (x,y);\n" +
