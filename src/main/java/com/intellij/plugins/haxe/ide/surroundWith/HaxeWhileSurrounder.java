...
import com.intellij.plugins.haxe.lang.psi.HaxeDoWhileBody;
...
public class HaxeWhileSurrounder extends HaxeManyStatementsSurrounder {
  ...
  protected PsiElement doSurroundElements(PsiElement[] elements, PsiElement parent) {
    ...
    //TODO .getBlockStatement()
    List<HaxeBlockStatement> blockStatementList = null != body ? body.getBlockStatement().getBlockStatementList() : Collections.emptyList();
