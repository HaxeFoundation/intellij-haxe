...
public class HaxeClassInheritanceFileIndex extends  FileBasedIndexExtension<String, List<HaxeComponentIndexData>> {

    private static final ID<String, List<HaxeComponentIndexData>> INDEX = ID.create("HaxeSuperClassIndex");
    ...
    public @NotNull DataIndexer<String, List<HaxeComponentIndexData>, FileContent> getIndexer() {
        return new HaxeClassInheritanceIndexer();
    }
