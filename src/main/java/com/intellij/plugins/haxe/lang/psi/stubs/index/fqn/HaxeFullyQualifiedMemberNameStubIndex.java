...
public class HaxeFullyQualifiedMemberNameStubIndex extends StringStubIndexExtension<PsiElement> {

  public static final StubIndexKey<String, PsiElement> KEY = StubIndexKey.createIndexKey("haxe.member.fqn");
