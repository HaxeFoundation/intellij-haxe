...
public class HaxeModuleFieldNameStubIndex extends StringStubIndexExtension<HaxePsiField> {

  public static final StubIndexKey<String, HaxePsiField> KEY = StubIndexKey.createIndexKey("haxe.module.field.name");
