    ...
    return new ItemPresentation() {
      ...
      public String getPresentableText() {
        ...
        if (model == null) {
          ...
          final HaxeTypeTag typeTag = PsiTreeUtil.getStubChildOfType(AbstractHaxeNamedComponent.this, HaxeTypeTag.class);
          if (null != typeTag) {
      ...
      public String getLocationString() {
        HaxeClass haxeClass = AbstractHaxeNamedComponent.this instanceof HaxeClass
                              ...
                              : PsiTreeUtil.getStubOrPsiParentOfType(AbstractHaxeNamedComponent.this, HaxeClass.class);
        String path = "";
