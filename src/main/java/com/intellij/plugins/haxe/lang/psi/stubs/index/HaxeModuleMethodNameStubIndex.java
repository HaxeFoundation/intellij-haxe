...
public class HaxeModuleMethodNameStubIndex extends StringStubIndexExtension<HaxeMethod> {

  public static final StubIndexKey<String, HaxeMethod> KEY = StubIndexKey.createIndexKey("haxe.module.method.name");
