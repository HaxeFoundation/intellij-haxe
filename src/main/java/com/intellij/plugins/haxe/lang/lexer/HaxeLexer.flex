...
%%
%{
    static final com.intellij.openapi.diagnostic.Logger LOG = com.intellij.openapi.diagnostic.Logger.getInstance(com.intellij.plugins.haxe.lang.lexer._HaxeLexer.class);
    static {      // Take this out when finished debugging.
      LOG.setLevel(com.intellij.openapi.diagnostic.LogLevel.DEBUG);
    }
