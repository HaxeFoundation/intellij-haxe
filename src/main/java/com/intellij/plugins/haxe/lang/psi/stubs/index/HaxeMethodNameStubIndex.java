...
public class HaxeMethodNameStubIndex extends StringStubIndexExtension<HaxeMethod> {

  public static final StubIndexKey<String, HaxeMethod> KEY = StubIndexKey.createIndexKey("haxe.method.name");
