...
public class HaxeStaticMethodNameStubIndex extends StringStubIndexExtension<HaxeMethod> {

    public static final StubIndexKey<String, HaxeMethod> KEY = StubIndexKey.createIndexKey("haxe.static.member.name");
