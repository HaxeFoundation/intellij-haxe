...
public abstract class HaxePsiFieldImpl extends AbstractHaxeNamedComponent implements HaxePsiField {
  ...
  @NotNull
  public List<HaxeFieldModifier> getFieldModifierList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, HaxeFieldModifier.class);
  }

  @NotNull
  public HaxeMutabilityModifier getMutabilityModifier() {
    return findNotNullChildByClass(HaxeMutabilityModifier.class);
  }
