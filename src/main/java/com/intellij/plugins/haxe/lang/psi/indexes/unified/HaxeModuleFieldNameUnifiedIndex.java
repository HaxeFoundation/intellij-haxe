...
import com.intellij.plugins.haxe.lang.psi.indexes.filebased.extension.HaxeModuleFieldNameFileIndex;
import com.intellij.plugins.haxe.lang.psi.indexes.filebased.extension.HaxeStaticFieldNameFileIndex;
import com.intellij.plugins.haxe.lang.psi.stubs.index.HaxeModuleFieldNameStubIndex;
...
public class HaxeModuleFieldNameUnifiedIndex {


    public static Collection<String> getAllKeys(@NotNull Project project) {

        Collection<String> stubKeys = StubIndex.getInstance().getAllKeys(HaxeModuleFieldNameStubIndex.KEY, project);
        Collection<String> fileKeys = FileBasedIndex.getInstance().getAllKeys(HaxeModuleFieldNameFileIndex.INDEX, project);
    ...
    public static Collection<HaxePsiField> getByName(@NotNull String name,
        ...
        Collection<HaxePsiField> stubResults = HaxeModuleFieldNameStubIndex.getByName(name, project, searchScope);
        Collection<HaxePsiField> fileResults = HaxeModuleFieldNameFileIndex.getByName(name, project, searchScope);
    ...
    public static List<HaxeMemberLookupData> getCompletionData(@NotNull String name,
        ...
        Collection<HaxePsiField> stubResults = HaxeModuleFieldNameStubIndex.getByName(name, project, scope);
        Collection<HaxeComponentIndexData> values = HaxeModuleFieldNameFileIndex.getValues(name, project, scope);
