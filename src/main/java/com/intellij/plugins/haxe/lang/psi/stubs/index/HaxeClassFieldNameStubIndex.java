...
public class HaxeClassFieldNameStubIndex extends StringStubIndexExtension<HaxePsiField> {

  public static final StubIndexKey<String, HaxePsiField> KEY = StubIndexKey.createIndexKey("haxe.field.name");
