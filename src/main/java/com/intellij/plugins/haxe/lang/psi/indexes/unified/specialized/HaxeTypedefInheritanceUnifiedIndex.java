...
import com.intellij.plugins.haxe.lang.psi.indexes.filebased.extension.specialized.HaxeTypedefInheritanceFileIndex;
...
public class HaxeTypedefInheritanceUnifiedIndex {
    ...
    public static List<HaxeClass> getBySuper(@NotNull String name,
        ...
        Collection<HaxeClass> stubResults = HaxeTypedefInheritanceStubIndex.getBySuper(name, project, searchScope);
        Collection<HaxeClass> fileResults = HaxeTypedefInheritanceFileIndex.getBySuper(name, project, searchScope);
