...
public class HaxelibProjectUpdater  {
  ...
  public static void addLibraries(final Module module, final List<HaxelibItem> haxelibNewItems) {
    ...
    ApplicationManager.getApplication().runWriteAction(new Runnable() {
      @Override
      public void run() {
        HaxeDebugTimeLog timeLog = HaxeDebugTimeLog.startNew("HaxelibProjectUpdater.addLibraries.run for module" + module.getName());
  ...
  public void addProjectLibrariesToModules(Project project, List<HaxelibItem> libs) {
  ...
  public void findUsedLibrariesAndAddToProject(ProjectTracker tracker) {
//  public void findUsedLibrariesAndAddToProject() {
   ...
   */
  final class ProjectTracker {
    final Project myProject;
    boolean myIsDirty;
    boolean myIsUpdating;
    ProjectClasspathCache myCache;
    HaxelibLibraryManager myLibraryManager;
    ...
    public ProjectTracker(Project project) {
      ...
      myLibraryManager = new HaxelibLibraryManager();
    }
