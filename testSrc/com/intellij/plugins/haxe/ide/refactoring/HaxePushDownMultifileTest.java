...
import com.intellij.plugins.haxe.ide.refactoring.memberPushDown.PushDownProcessor;
 ...
 */
public class HaxePushDownMultifileTest extends MultiFileTestCase {
  @Override
  ...
  private void doTestMethod(final String... conflicts) throws Exception {
    ...
    doTest(new PerformAction() {
      ...
      public void performAction(final VirtualFile rootDir, final VirtualFile rootAfter) throws Exception {
        final PsiClass srcClass = HaxeResolveUtil.findClassByQName("b.B", getPsiManager(), GlobalSearchScope.allScope(myProject));
        assertTrue("Source class not found", srcClass != null);
        final PsiClass targetClass = HaxeResolveUtil.findClassByQName("a.A", getPsiManager(), GlobalSearchScope.allScope(myProject));
  ...
  public void testFromSuperClassToClass() throws Exception {
    doTestMethod();
  }

  public void testMoveFieldFromSuperClassToClass() throws Exception {
    doTestField();
  }

  public void testMoveFieldWithInitializerFromSuperClassToClass() throws Exception {
    doTestField();
  }

  public void testFromInterfaceToClass() throws Exception {
    doTestMethod();
  }
