...
public class HaxeFindUsagesTest extends HaxeCodeInsightFixtureTestCase {
  ...
  @Test public void testProperties1() throws Throwable {
    myFixture.configureByFiles("Properties1.hx");
    doTest(1);
  }

  @Test public void testProperties2() throws Throwable {
    myFixture.configureByFiles("Properties2.hx");
    doTest(1);
  }

  @Test public void testVarDeclaration() throws Throwable {
    myFixture.configureByFiles("VarDeclaration.hx", "com/bar/Foo.hx");
    doTest(0);
  }

  @Test public void testLocalFunctionParameter() throws Throwable {
    myFixture.configureByFiles("LocalFunctionParameter.hx", "com/bar/Foo.hx");
    doTest(3);
  }

  @Test public void testForDeclaration() throws Throwable {
    myFixture.configureByFiles("ForDeclaration.hx", "com/bar/IBar.hx");
    doTest(3);
  }

  @Test public void testLocalVarDeclaration1() throws Throwable {
    myFixture.configureByFiles("LocalVarDeclaration1.hx");
    doTest(1);
  }

  @Test public void testLocalVarDeclaration2() throws Throwable {
    myFixture.configureByFiles("LocalVarDeclaration2.hx");
    doTest(1);
  }

  @Test public void testFunctionParameter() throws Throwable {
    myFixture.configureByFiles("FunctionParameter.hx");
    doTest(2);
  }

  @Test public void testClassDeclaration() throws Throwable {
    myFixture.configureByFiles("com/bar/ClassToFind.hx", "ClassDeclaration.hx");
    doTest(7);
  }

  @Test public void testClassConstructor() throws Throwable {
  ...
  @Test public void testFindCurrentClass() throws Throwable {
    doOverrideTest( "OverrideTop.hx", GET_CURRENT_CLASS);
  }

  @Test public void testFindBaseClass() throws Throwable {
    doOverrideTest("OverrideTop.hx", GET_BASE_CLASS);
  }

  @Test public void testFindAncestorClass() throws Throwable {
