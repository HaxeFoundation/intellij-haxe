...
public class HXMLLibImpl extends ASTWrapperPsiElement implements HXMLLib {

  public HXMLLibImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof HXMLVisitor) ((HXMLVisitor)visitor).visitLib(this);
