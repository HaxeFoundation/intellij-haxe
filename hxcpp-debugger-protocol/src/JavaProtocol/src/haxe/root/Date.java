...
public class Date extends haxe.lang.HxObject
{
	...
	{
		//line 101 "/usr/local/lib/haxe/std/java/_std/Date.hx"
		haxe.root.Date d = new haxe.root.Date(0, 0, 0, 0, 0, 0);
		//line 102 "/usr/local/lib/haxe/std/java/_std/Date.hx"
		d.date = new java.util.Date(((long) (t) ));
		//line 103 "/usr/local/lib/haxe/std/java/_std/Date.hx"
		return d;
	}
	...
	{
		//line 108 "/usr/local/lib/haxe/std/java/_std/Date.hx"
		int _g = s.length();
		//line 108 "/usr/local/lib/haxe/std/java/_std/Date.hx"
		switch (_g)
		{
			case 8:
			{
				//line 111 "/usr/local/lib/haxe/std/java/_std/Date.hx"
				haxe.root.Array<java.lang.String> k = haxe.lang.StringExt.split(s, ":");
				//line 112 "/usr/local/lib/haxe/std/java/_std/Date.hx"
				...
				//line 113 "/usr/local/lib/haxe/std/java/_std/Date.hx"
				return d;
			}
			...
			case 10:
			{
				//line 115 "/usr/local/lib/haxe/std/java/_std/Date.hx"
				haxe.root.Array<java.lang.String> k1 = haxe.lang.StringExt.split(s, "-");
				//line 116 "/usr/local/lib/haxe/std/java/_std/Date.hx"
			...
			default:
			{
				//line 123 "/usr/local/lib/haxe/std/java/_std/Date.hx"
