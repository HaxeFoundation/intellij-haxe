...
public class Std
{
	...
	public static double parseFloat(java.lang.String x)
	{
		...
		int i = -1;
		//line 146 "/usr/local/lib/haxe/std/java/_std/Std.hx"
		{
			//line 146 "/usr/local/lib/haxe/std/java/_std/Std.hx"
			label1:
			//line 146 "/usr/local/lib/haxe/std/java/_std/Std.hx"
			while ((  ++ i < x.length() ))
			{
				//line 148 "/usr/local/lib/haxe/std/java/_std/Std.hx"
				int chr = ((int) (((char) (x.charAt(i)) )) );
				//line 149 "/usr/local/lib/haxe/std/java/_std/Std.hx"
				if (( ( chr >= 48 ) && ( chr <= 57 ) )) 
				{
					...
					//line 155 "/usr/local/lib/haxe/std/java/_std/Std.hx"
					found = true;
				}
				else
				{
					...
					switch (chr)
					{
						case 101:
						{
							...
							if ( ! (hasE) ) 
							{
								//line 158 "/usr/local/lib/haxe/std/java/_std/Std.hx"
								hasE = true;
							}
							else
							{
								//line 166 "/usr/local/lib/haxe/std/java/_std/Std.hx"
								break label1;
							}
						...
						case 46:
						{
							...
							if ( ! (hasDot) ) 
							{
								//line 160 "/usr/local/lib/haxe/std/java/_std/Std.hx"
								hasDot = true;
							}
							else
							{
						...
						case 45:
						{
							//line 161 "/usr/local/lib/haxe/std/java/_std/Std.hx"
							if ((  ! (found)  &&  ! (hasSign)  )) 
							{
								//line 162 "/usr/local/lib/haxe/std/java/_std/Std.hx"
								hasSign = true;
							}
							else
							{
								//line 163 "/usr/local/lib/haxe/std/java/_std/Std.hx"
								if (( ( ( found &&  ! (hasESign)  ) && hasE ) &&  ! (hasEData)  )) 
								{
									//line 164 "/usr/local/lib/haxe/std/java/_std/Std.hx"
									hasESign = true;
								}
								else
								{
		...
		//line 169 "/usr/local/lib/haxe/std/java/_std/Std.hx"
		if (( hasE &&  ! (hasEData)  )) 
		{
			//line 171 "/usr/local/lib/haxe/std/java/_std/Std.hx"
			i--;
		...
		//line 176 "/usr/local/lib/haxe/std/java/_std/Std.hx"
		if (( i != x.length() )) 
		{
			//line 178 "/usr/local/lib/haxe/std/java/_std/Std.hx"
			x = haxe.lang.StringExt.substr(x, 0, i);
		}
		
		//line 181 "/usr/local/lib/haxe/std/java/_std/Std.hx"
		try 
		{
			//line 181 "/usr/local/lib/haxe/std/java/_std/Std.hx"
		...
		catch (java.lang.Throwable __temp_catchallException1)
		{
			...
			//line 183 "/usr/local/lib/haxe/std/java/_std/Std.hx"
