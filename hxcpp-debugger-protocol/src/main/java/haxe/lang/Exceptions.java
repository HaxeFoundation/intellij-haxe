...
public class Exceptions extends HxObject
{
	static
	{
		...
		Exceptions.exception = new ThreadLocal<Throwable>();
	}
	...
	public static void __hx_ctor_haxe_lang_Exceptions(Exceptions __hx_this)
	{
	}
	
	
	public static ThreadLocal<Throwable> exception;
	
	public static void setException(Throwable exc)
	{
		//line 33 "C:\\HaxeToolkit\\haxe\\std\\java\\internal\\Exceptions.hx"
		Exceptions.exception.set(((Throwable) (exc) ));
	}
